...
-->
                    ...
                    <div class="row mt-5">
                        <div class="col-sm-6">
                            <div class="abt_cont">
                                ...
                                <div class="abt_detls">
                                    <h4 class="mt-3">Why our water?</h4>
                                    <p>
                                        onsectetur adipisicing elit, sedo eiusmod tempor incidi et dolorerserss eerhfre mag.
                                    </p>
                                </div>
                        ...
                        <div class="col-sm-6">
                            <div class="abt_cont">
                                ...
                                <div class="abt_detls">
                                    <h4 class="mt-3">what's difference?</h4>
                                    <p>
                                        onsectetur adipisicing elit, sedo eiusmod tempor incidi et dolorerserss eerhfre mag.
                                    </p>
                                </div>
    ...
    <!-- end of services -->
    <section class="full-work">
        <!--filter contol-->
        <div class="container">
            <div class="row work">
                <h1>WORK</h1>
                <P>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Repellendus, quidem quis odio corporis exercitationem eius, at, porro, sunt mollitia fugit minima autem nobis consequatur.</P>
            </div>
            <div class="row filterBtn">
                <button class="active" type="button" data-filter="all">ALL</button>
                <button type="button" data-filter=".c-1">PAINTING</button>
                <button type="button" data-filter=".c-2">ROOFINF</button>
                <button type="button" data-filter=".c-3"> RENOVATIONS</button>
            </div>
            <!--filter Images section-->
            <div class="row mixitup">
                <div class="col-sm-3 com mix c-2 c-3">
                    <div class="filter-images">
                        <div class="filter_overlay">
                            <h3>PHOTOGRAPHY</h3>
                            <a href="#"><i class="fa fa-eye" aria-hidden="true"></i>121</a>
                            <a href="#"><i class="fa fa-heart-o" aria-hidden="true"></i>50</a>
                        </div>
                    </div>
                    <img src="images/essentia-2-682x1024.jpg" alt="">
                </div>
                <div class="col-sm-3 com mix c-2">
                    <div class="filter-images">
                        <div class="filter_overlay">
                            <h3>PHOTOGRAPHY</h3>
                            <a href=""><i class="fa fa-eye" aria-hidden="true"></i>121</a>
                            <a href=""><i class="fa fa-heart-o" aria-hidden="true"></i>03</a>
                        </div>
                    </div>
                    <img src="images/essentia-2-682x1024.jpg" alt="">
                </div>
                <div class="col-sm-3 com mix c-2">
                    <div class="filter-images">
                        <div class="filter_overlay">
                            <h3>PHOTOGRAPHY</h3>
                            <a href=""><i class="fa fa-eye" aria-hidden="true"></i>121</a>
                            <a href=""><i class="fa fa-heart-o" aria-hidden="true"></i>05</a>
                        </div>
                    </div>
                    <img src="images/essentia-2-682x1024.jpg" alt="">
                </div>
                <div class="col-sm-3 com mix c-3">
                    <div class="filter-images">
                        <div class="filter_overlay">
                            <h3>PHOTOGRAPHY</h3>
                            <a href=""><i class="fa fa-eye" aria-hidden="true"></i>121</a>
                ...
                <div class="col-sm-3 com mix c-1 c-3">
                    <div class="filter-images">
                        <div class="filter_overlay">
                            <h3>PHOTOGRAPHY</h3>
                            <a href=""><i class="fa fa-eye" aria-hidden="true"></i>121</a>
                ...
                <div class="col-sm-3 com mix c-2 c-1">
                    <div class="filter-images">
                        <div class="filter_overlay">
                            <h3>PHOTOGRAPHY</h3>
                            <a href=""><i class="fa fa-eye" aria-hidden="true"></i>121</a>
            ...
            <div class="clr"></div>
            <div class="filter"><a href="#">VIEW ALL</a></div>
        </div>
    </section>
